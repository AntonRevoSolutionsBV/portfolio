...
function Portfolio() {
    return (
     <div id='portfolio-main'>
        ...
        <p className='portfolio-note'>Note: 
        ...
        <div className='portfolio-entry-right'>
            <h2>This website</h2>
            <p className='portfolio-p'>React | HTML | CSS | JavaScript | Responsive Design | Mobile </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={site}></img>
            </div>
        ...
        <div className='portfolio-entry-right'>
            ...
            <p className='portfolio-p'>HTML | CSS </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={cv}></img>
            </div>
            <div className='portfolio-entry-text'>
        ...
        <div className='portfolio-entry-right'>
            ...
            <p className='portfolio-p'>HTML | CSS | JavaScript </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={invoiceGen}></img>
            </div>
            <div className='portfolio-entry-text'>
        ...
        <div className='portfolio-entry-right'>
            ...
            <p className='portfolio-p'>HTML | CSS | Responsive Design  </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={youtube}></img>
            </div>
            <div className='portfolio-entry-text'>
        ...
        <div className='portfolio-entry-right'>
            ...
            <p className='portfolio-p'>HTML | CSS | JavaScript | Responsive Design  </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={amazon}></img>
            </div>
            <div className='portfolio-entry-text'>
            <p>
        ...
        <div className='portfolio-entry-right'>
            ...
            <p className='portfolio-p'>HTML | CSS | JavaScript | TypeScript | Responsive Design  </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={webstore}></img>
            </div>
            <div className='portfolio-entry-text'>
            <p>
        ...
        <div className='portfolio-entry-right'>
            <h2>Travel Blog</h2>
            <p className='portfolio-p'>React | JavaScript | HTML | CSS  </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={travelblog}></img>
            </div>
            <div className='portfolio-entry-text'>
            <p>
        ...
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={endgame}></img>
            </div>
            <div className='portfolio-entry-text'>
            <p>
        ...
        <div className='portfolio-entry-right'>
            <h2>PrintForge</h2>
            <p className='portfolio-p'>NextJS | React | JavaScript | HTML | CSS  </p>
            
        </div>
        <div className='portfolio-entry-bottom'>
            <div className='img-container'>
            <img className='portfolio-img' src={printforge}></img>
            </div>
            <div className='portfolio-entry-text'>
            <p>
