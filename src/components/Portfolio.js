    ...
    return (
     <div id='portfolio-main'>
        ...
        <div class='portfolio-entry-right'>
            <h2>This website</h2>
            <p class='portfolio-p'>React | HTML | CSS | JavaScript </p>
            <p>I designed this portfolio website using React to showcase some of my abilities I have acquired over the years working in my own start-up. <br/>I decided to go with React, because it facilitates the reusability of the custom components, which is very useful for a page that is supposed to be updated on a regular basis.  <br />
             <br />
        ...
        <div class='portfolio-entry-right'>
            ...
            <br /> Creating layouts and styles in HTML and CSS has become a second nature for me at this point, so I use it often to create printed documents.
            </p>
        </div>
        </div>
        ...
        <div class='portfolio-entry-right'>
            ...
            <p>This is a custom application that takes customer data and items either as a direct input or from a data storage, then prints a complete invoice in a pdf-pritable standard A4 format. It was designed to be used as a standalone application, as well as being a seperate module for a webstore.
             <br />
            It has several smart features that are coded with JavaScript. For example, the default date will be set to the actual current date. The application will check for a VAT-number and apply VAT-reverse-charge when needed. The application knows if a certain article is already on the list, and will not add an extra line if you want to add more of it to the invoice, it will just increase the quantity.
        ...
        <div class='portfolio-entry-right'>
            ...
            <p class='portfolio-p'>JavaScript | HTML | CSS | Responsive Design</p>
            <p>This small project was done to practice my HTML and CSS skills. The idea was to replicate the layout of a well known site. It features Responsive Design, flexbox, grid, among other techniques which were coded using CSS. 
        ...
        <div class='portfolio-entry-right'>
            <h2>Electronics webstore prototype</h2>
            <p class='portfolio-p'>JavaScript | TypeScript | HTML | CSS</p>
            <p>This is a basic webstore for DIY electronics. Functionality includes generating instance from a database located on the backend, filtering results and adding products to a shopping cart.
        ...
        <div class='portfolio-entry-right'>
            <h2>Travel Blog</h2>
            <p class='portfolio-p'>React | TypeScript | HTML | CSS</p>
            <p>A basic personalized blog, designed using React framework. It uses a dataset to dynamically generate different entries. As always, the styling was done using CSS, and the basic layout is done with HTML.</p>
        </div>
        </div>
        ...
        <div class='portfolio-entry-right'>
            ...
            <p>A classic 'hangman' type of game, with twist. The idea is to guess the word before you run out of programming languages and left with only the Assembly.
                <br />
                The word is picked randomly from a dictionary, each time you guess a wrong letter, one programming language is removed. This small app combines styling using CSS with functionality provided by React logic.
            </p>
        </div>
        </div>
        ...
        <div class='portfolio-entry-right'>
            ...
            <p>This is a small web page made with NextJS framework. The framwork comes into play mostly by facilitating routing and creating layouts that are shared between different pages.</p>
        </div>
        </div>
